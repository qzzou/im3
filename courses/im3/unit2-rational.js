...
const unit2 = {
    ...
    lessons: [
        ...
        },
        {
            ...
            content: `
                <div class="formula-box">
                    <strong>Multiplication:</strong> $\\frac{a}{b} \\cdot \\frac{c}{d} = \\frac{ac}{bd}$ (then simplify)<br><br>
                    <strong>Division:</strong> $\\frac{a}{b} \\div \\frac{c}{d} = \\frac{a}{b} \\cdot \\frac{d}{c}$<br><br>
        ...
        },
        {
            ...
            content: `
                <div class="formula-box">
                    ...
                    &nbsp;&nbsp;- $\\deg(\\text{num}) < \\deg(\\text{den})$: $y = 0$<br>
                    &nbsp;&nbsp;- $\\deg(\\text{num}) = \\deg(\\text{den})$: $y =$ leading coeff ratio<br>
                    &nbsp;&nbsp;- $\\deg(\\text{num}) > \\deg(\\text{den})$: No HA (slant asymptote if deg differs by 1)
                </div>
            `
        },
        {
    ...
    exercises: [
        ...
        },
        {
            ...
            solution: `<strong>Step 1: LCD $= (x + 2)(x - 1)$</strong><br><br>
                ...
                $\\frac{3(x-1)}{\\text{LCD}} - \\frac{2(x+2)}{\\text{LCD}}$<br><br>
                <strong>Step 3: Combine</strong><br>
                $\\frac{3x - 3 - 2x - 4}{(x+2)(x-1)}$<br>
                $= $ <strong>$\\frac{x - 7}{(x + 2)(x - 1)}$</strong>`,
            hard: true
        },
        {
            id: 'u2-4',
            unit: 2,
            question: 'Solve: $\\frac{2}{x} + \\frac{3}{x+2} = 1$',
            answer: '-1,4',
            answerType: 'zeros',
            zeros: [-1, 4],
        ...
        },
        {
            id: 'u2-5',
            unit: 2,
            question: 'Find the horizontal asymptote of $f(x) = \\frac{3x^2 + 2x - 1}{2x^2 - 5}$',
            answer: '$y = \\frac{3}{2}$',
            hint: 'Compare degrees. When equal, HA $=$ ratio of leading coefficients.',
            solution: `<strong>Step 1: Compare degrees</strong><br>
                $\\deg(\\text{num}) = 2$, $\\deg(\\text{den}) = 2$<br>
                Degrees are equal!<br><br>
                <strong>Step 2: Apply rule</strong><br>
                HA $=$ (leading coeff of num)/(leading coeff of den)<br>
                <strong>$y = \\frac{3}{2}$</strong>`,
            hard: true
        },
        {
            id: 'u2-6',
            unit: 2,
            question: 'Solve: $\\frac{1}{x-2} + \\frac{1}{x+2} = \\frac{4}{x^2-4}$',
            answer: 'nosolution',
            hint: 'Notice $x^2 - 4 = (x-2)(x+2)$. Solve and check for extraneous solutions!',
    ...
    generators: [
        ...
        function() {
            ...
            const numExpanded = `x^2 ${a+b >= 0 ? '+' : '-'} ${Math.abs(a+b)}x ${a*b >= 0 ? '+' : '-'} ${Math.abs(a*b)}`;
            const denExpanded = `x^2 ${a+c >= 0 ? '+' : '-'} ${Math.abs(a+c)}x ${a*c >= 0 ? '+' : '-'} ${Math.abs(a*c)}`;

            return {
                unit: 2,
                question: `Simplify: $\\frac{${numExpanded}}{${denExpanded}}$`,
                answer: `$\\frac{x${b >= 0 ? '+' : '-'}${Math.abs(b)}}{x${c >= 0 ? '+' : '-'}${Math.abs(c)}}$`,
                hint: `Factor both numerator and denominator, then cancel common factors.`,
                solution: `<strong>Step 1: Factor numerator</strong><br>
                    ...
                    $= $ <strong>$\\frac{x ${b >= 0 ? '+' : '-'} ${Math.abs(b)}}{x ${c >= 0 ? '+' : '-'} ${Math.abs(c)}}$</strong>, $x \\neq ${-a}$`,
                hard: false
            };
        },
        ...
        function() {
            ...
            return {
                unit: 2,
                question: `Find the vertical asymptote(s) of $f(x) = \\frac{x ${a >= 0 ? '+' : '-'} ${Math.abs(a)}}{x^2 ${-b+a >= 0 ? '+' : '-'} ${Math.abs(-b+a)}x ${-b*a >= 0 ? '+' : '-'} ${Math.abs(-b*a)}}$`,
                answer: `$x = ${b}$`,
                ...
                solution: `<strong>Step 1: Factor denominator</strong><br>
                    $x^2 ${-b+a >= 0 ? '+' : '-'} ${Math.abs(-b+a)}x ${-b*a >= 0 ? '+' : '-'} ${Math.abs(-b*a)} = (x ${-b >= 0 ? '+' : '-'} ${Math.abs(b)})(x ${a >= 0 ? '+' : '-'} ${Math.abs(a)})$<br><br>
                    <strong>Step 2: Simplify</strong><br>
                    $f(x) = \\frac{x ${a >= 0 ? '+' : '-'} ${Math.abs(a)}}{(x ${-b >= 0 ? '+' : '-'} ${Math.abs(b)})(x ${a >= 0 ? '+' : '-'} ${Math.abs(a)})}$<br><br>
                    <strong>Step 3: Cancel</strong><br>
        ...
        function() {
            ...
            return {
                unit: 2,
                question: `Simplify: $\\frac{${a}}{x ${c >= 0 ? '+' : '-'} ${Math.abs(c)}} - \\frac{${b}}{x ${d >= 0 ? '+' : '-'} ${Math.abs(d)}}$`,
                answer: `$\\frac{${a-b}x${constResult >= 0 ? '+' : ''}${constResult}}{(x${c >= 0 ? '+' : ''}${c})(x${d >= 0 ? '+' : ''}${d})}$`,
                ...
                solution: `<strong>Step 1: LCD $= (x ${c >= 0 ? '+' : '-'} ${Math.abs(c)})(x ${d >= 0 ? '+' : '-'} ${Math.abs(d)})$</strong><br><br>
                    ...
                    $\\frac{${a}(x ${d >= 0 ? '+' : '-'} ${Math.abs(d)})}{\\text{LCD}} - \\frac{${b}(x ${c >= 0 ? '+' : '-'} ${Math.abs(c)})}{\\text{LCD}}$<br><br>
                    <strong>Step 3: Expand numerators</strong><br>
                    $\\frac{${a}x ${a*d >= 0 ? '+' : '-'} ${Math.abs(a*d)} - ${b}x ${-b*c >= 0 ? '+' : '-'} ${Math.abs(b*c)}}{\\text{LCD}}$<br><br>
                    <strong>Step 4: Combine</strong><br>
                    $= $ <strong>$\\frac{${a-b}x ${constResult >= 0 ? '+' : '-'} ${Math.abs(constResult)}}{(x ${c >= 0 ? '+' : '-'} ${Math.abs(c)})(x ${d >= 0 ? '+' : '-'} ${Math.abs(d)})}$</strong>`,
                hard: true
            };
        },
        ...
        function() {
            ...
            return {
                unit: 2,
                question: `Solve: $\\frac{${a}}{x} + \\frac{${b}}{x ${c >= 0 ? '+' : '-'} ${Math.abs(c)}} = 1$`,
                answer: zeros.join(','),
                answerType: 'zeros',
                zeros: zeros,
                ...
                solution: `<strong>Step 1: LCD $= x(x ${c >= 0 ? '+' : '-'} ${Math.abs(c)})$</strong><br><br>
                    ...
                    $${a}x ${a*c >= 0 ? '+' : '-'} ${Math.abs(a*c)} + ${b}x = x^2 ${c >= 0 ? '+' : '-'} ${Math.abs(c)}x$<br>
                    $x^2 ${p >= 0 ? '+' : '-'} ${Math.abs(p)}x ${q >= 0 ? '+' : '-'} ${Math.abs(q)} = 0$<br><br>
                    <strong>Step 3: Factor and solve</strong><br>
        ...
        function() {
            ...
            return {
                unit: 2,
                question: `Find the horizontal asymptote of $f(x) = \\frac{${a}x^2 ${c >= 0 ? '+' : '-'} ${Math.abs(c)}x + 1}{${b}x^2 ${d >= 0 ? '+' : '-'} ${Math.abs(d)}}$`,
                answer: `$y = \\frac{${a}}{${b}}$`,
                hint: `Compare degrees of numerator and denominator. When equal, HA $=$ ratio of leading coefficients.`,
                solution: `<strong>Step 1: Compare degrees</strong><br>
                    $\\deg(\\text{numerator}) = 2$<br>
                    $\\deg(\\text{denominator}) = 2$<br>
                    Degrees are equal!<br><br>
                    <strong>Step 2: Apply rule</strong><br>
                    When degrees are equal, HA $=$ (leading coeff of num)/(leading coeff of den)<br>
                    HA: <strong>$y = \\frac{${a}}{${b}}$</strong>`,
                hard: false
            };
        },
        ...
        function() {
            ...
            return {
                unit: 2,
                question: `Solve: $\\frac{1}{x - ${a}} + \\frac{1}{x + ${a}} = \\frac{${2*a}}{x^2 - ${a*a}}$`,
                answer: 'nosolution',
                hint: `Notice $x^2 - ${a*a} = (x - ${a})(x + ${a})$. Solve and check for extraneous solutions!`,
                solution: `<strong>Step 1: Factor denominator</strong><br>
                    $x^2 - ${a*a} = (x - ${a})(x + ${a})$<br><br>
                    <strong>Step 2: Rewrite with LCD $= (x - ${a})(x + ${a})$</strong><br>
                    $\\frac{x + ${a}}{\\text{LCD}} + \\frac{x - ${a}}{\\text{LCD}} = \\frac{${2*a}}{\\text{LCD}}$<br><br>
