...
const satUnit3 = {
    ...
    lessons: [
        {
            ...
            content: `
                ...
                <div class="formula-box">
                    <strong>Standard Form:</strong> $ax^2 + bx + c = 0$<br><br>
                    <strong>Quadratic Formula:</strong> $x = \\frac{-b \\pm \\sqrt{b^2 - 4ac}}{2a}$<br><br>
                    <strong>Factored Form:</strong> $a(x - r_1)(x - r_2) = 0$<br>
        ...
        },
        {
            ...
            content: `
                ...
                <div class="formula-box">
                    <strong>Discriminant:</strong> $D = b^2 - 4ac$<br><br>
                ...
                <div class="example">
                    <h4>SAT Tip:</h4>
                    <p>If asked "for what value of k does the equation have exactly one solution?", set $b^2 - 4ac = 0$!</p>
                </div>
            `
        },
        {
            ...
            content: `
                <div class="formula-box">
                    ...
                    Vertex x-coordinate: $x = -\\frac{b}{2a}$<br>
        ...
        },
        {
            ...
            content: `
                ...
                <div class="formula-box">
                    ...
                    <strong>Inverse:</strong> $f^{-1}(x)$ undoes $f(x)$<br>
    ...
    exercises: [
        ...
        },
        {
            ...
            hint: 'In vertex form $y = a(x - h)^2 + k$, the vertex is $(h, k)$. Watch the signs!',
            solution: `<strong>Identify vertex form:</strong><br>
                $y = (x - 3)^2 - 4$<br>
                $y = a(x - h)^2 + k$ where $a=1$, $h=3$, $k=-4$<br><br>
        ...
        },
        {
            id: 'sat3-4',
            unit: 3,
            question: 'For what value of $k$ will $x^2 + 6x + k = 0$ have exactly one solution?',
            answer: 'D',
            options: ['A) 0', 'B) 3', 'C) 6', 'D) 9'],
            hint: 'For exactly one solution, the discriminant must equal zero: $b^2 - 4ac = 0$.',
        ...
        },
        {
            id: 'sat3-5',
            unit: 3,
            question: 'What is the sum of the solutions to $2x^2 - 8x + 5 = 0$?',
            answer: 'B',
            options: ['A) 2', 'B) 4', 'C) 5', 'D) 8'],
            hint: 'For $ax^2 + bx + c = 0$, sum of roots $= -\\frac{b}{a}$ (Vieta\'s formulas).',
            solution: `<strong>Vieta's Formula:</strong><br>
                For $ax^2 + bx + c = 0$:<br>
                Sum of roots $= -\\frac{b}{a}$<br><br>
                <strong>Apply:</strong><br>
                Sum $= -\\frac{-8}{2} = \\frac{8}{2} = $ <strong>4</strong>`,
            hard: true
        },
        {
            id: 'sat3-6',
            unit: 3,
            question: 'If $g(x) = x^2 + 1$ and $f(x) = 2x$, what is $f(g(3))$?',
            answer: 'C',
    ...
    generators: [
        ...
        function() {
            ...
            return {
                unit: 3,
                question: `What are the solutions to $x^2 ${bSign} ${Math.abs(b)}x ${cSign} ${Math.abs(c)} = 0$?`,
                answer: letters[correctIndex],
                options: options.map((opt, i) => `${letters[i]}) $${opt.replace(/x = /g, 'x = ')}$`),
                hint: 'Factor the quadratic by finding two numbers that multiply to $c$ and add to $-b$.',
                solution: `<strong>Factor:</strong><br>
                    $x^2 ${bSign} ${Math.abs(b)}x ${cSign} ${Math.abs(c)} = (x ${r1 >= 0 ? '-' : '+'} ${Math.abs(r1)})(x ${r2 >= 0 ? '-' : '+'} ${Math.abs(r2)}) = 0$<br><br>
        ...
        function() {
            ...
            return {
                unit: 3,
                question: `What is the vertex of the parabola $y = ${aPart}${hPart}^2${kPart}$?`,
                answer: letters[correctIndex],
                options: options.map((opt, i) => `${letters[i]}) ${opt}`),
                hint: 'In vertex form $y = a(x - h)^2 + k$, the vertex is $(h, k)$. Watch the signs carefully!',
                solution: `<strong>Vertex Form:</strong> $y = a(x - h)^2 + k$<br><br>
        ...
        function() {
            ...
            return {
                unit: 3,
                question: `For what value of $k$ will $${a === 1 ? '' : a}x^2 ${bSign} ${Math.abs(b)}x + k = 0$ have exactly one solution?`,
                answer: letters[correctIndex],
                options: allAnswers.map((val, i) => `${letters[i]}) ${val}`),
                hint: 'For exactly one solution, set discriminant $= 0$: $b^2 - 4ac = 0$.',
                solution: `<strong>For one solution, discriminant $= 0$:</strong><br>
                    $b^2 - 4ac = 0$<br>
                    $(${b})^2 - 4(${a})(k) = 0$<br>
                    $${b * b} - ${4 * a}k = 0$<br>
        ...
        function() {
            ...
            return {
                unit: 3,
                question: `What is the ${askSum ? 'sum' : 'product'} of the solutions to $${a === 1 ? '' : a}x^2 ${bSign} ${Math.abs(b)}x ${cSign} ${Math.abs(c)} = 0$?`,
                answer: letters[correctIndex],
                options: allAnswers.map((val, i) => `${letters[i]}) ${val}`),
                hint: `Vieta's formulas: sum $= -\\frac{b}{a}$, product $= \\frac{c}{a}$. Don't forget the negative sign for sum!`,
                solution: `<strong>Vieta's Formulas for $ax^2 + bx + c = 0$:</strong><br>
                    Sum of roots $= -\\frac{b}{a} = -\\frac{${b}}{${a}} = ${-b/a}$<br>
                    Product of roots $= \\frac{c}{a} = \\frac{${c}}{${a}} = ${c/a}$<br><br>
        ...
        function() {
            ...
            return {
                unit: 3,
                question: `If $g(x) = x^2 + ${b}$ and $f(x) = ${a}x$, what is $${questionFunc}(${x}))$?`,
                answer: letters[correctIndex],
                options: allAnswers.map((val, i) => `${letters[i]}) ${val}`),
                ...
                solution: askFG ?
                    ...
                    $g(${fResult}) = ${fResult}^2 + ${b} = $ <strong>${gfAnswer}</strong><br><br>
        ...
        function() {
            ...
            return {
                unit: 3,
                question: `A ball is thrown upward from a height of ${h0} feet with an initial velocity of ${v0} feet per second. Its height $h$ after $t$ seconds is given by $h = -16t^2 + ${v0}t + ${h0}$. What is the maximum height the ball reaches?`,
                answer: letters[correctIndex],
                options: allAnswers.map((val, i) => `${letters[i]}) ${val} feet`),
                hint: 'The maximum height of a parabola opening downward is at the vertex. Use $t = -\\frac{b}{2a}$ to find when, then plug back in.',
                solution: `<strong>Maximum is at vertex of parabola</strong><br><br>
                    <strong>Time at max:</strong> $t = -\\frac{b}{2a} = -\\frac{${v0}}{2 \\times -16} = ${v0/32}$ seconds<br><br>
                    <strong>Max height:</strong><br>
                    $h = -16(${v0/32})^2 + ${v0}(${v0/32}) + ${h0}$<br>
